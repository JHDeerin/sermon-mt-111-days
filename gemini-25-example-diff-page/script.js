document.addEventListener('DOMContentLoaded', () => {
    ...
    const combinedOutputDiv = document.getElementById('combinedOutput'); // Add
    ...
    compareButton.addEventListener('click', () => {
        const refText = referenceTextarea.value;
        ...
        combinedOutputDiv.innerHTML = generateCombinedHtmlFromOps(usrText, diffOperations);
    });

    // Initial comparison on load (optional)
    // compareButton.click();
});